...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline:
      'bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-600 focus:ring-indigo-500',
    danger:
